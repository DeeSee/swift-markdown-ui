...
//extension Sequence where Element == MarkdownContent.IdentifiedBlockNode {
//  func filterImagesMatching(colorScheme: ColorScheme) -> [MarkdownContent.IdentifiedBlockNode] {
